                ...
                <div className="project-form-body">
                  ...
                  <span>
                      <div className="form-floating">
                        <input type="number" className="form-control mb-3" id="floatingPassword" placeholder="bid amount ..." value={bidAmount} onChange={(e)=>setBidAmount(e.target.value)} />
                        <label htmlFor="floatingPassword">Budget</label>
                      </div>
                      <div className="form-floating">
                        <input type="number" className="form-control mb-3" id="floatingPassword" placeholder="estimatedTime ..." value={estimatedTime} onChange={(e)=>setEstimatedTime(e.target.value)} />
                        <label htmlFor="floatingPassword">Estimated time (days)</label>
                      </div>
                  </span>
                  <div className="form-floating">
                        <textarea className="form-control mb-3" id="floatingPassword" placeholder="proposal ..." value={proposal} onChange={(e)=>setProposal(e.target.value)}/>
